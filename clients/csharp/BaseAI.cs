...
public abstract class BaseAI
{
  ...
  /// </summary>
  /// <returns>Returns the number of sarcophagi each player will start with each round.</returns>
  public int numberOfSarcophagi()
  {
    int value = Client.getNumberOfSarcophagi(connection);
    return value;
  }
}
